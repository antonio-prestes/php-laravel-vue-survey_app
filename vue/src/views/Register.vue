<template>
    <div>
        ...
        <p class="mt-2 text-center text-sm text-gray-600">
            or
            {{ ' ' }}
            <router-link :to="{name: 'Login'}" class="font-medium text-indigo-600 hover:text-indigo-500"> Login into
                your account
            </router-link>
        </p>
    </div>
    <form class="mt-8 space-y-6" @submit="register">
        ...
        <div class="rounded-md shadow-sm -space-y-px">
            <div>
                ...
                <input id="fullname" name="text" type="text" autocomplete="name" required="" v-model="user.name"
